...
const Project = () => {
    return (
        <div className="container mx-auto py-8 max-w-4xl">
            ...
            <h1 className="text-3xl font-bold mt-6 mb-2">Project</h1>
            ...
            <div className="prose max-w-none space-y-8">
                <section>
                    <h2 className="text-2xl font-semibold mb-4">About PrevNet</h2>
                ...
                <section>
                    <h2 className="text-2xl font-semibold mb-4">What Are Preverbs?</h2>
                ...
                <section>
                    ...
                    <div className="space-y-6 mt-4">
                        <div>
                            <h3 className="text-xl font-bold">Andrea Farina (Principal Investigator / PhD Candidate)</h3>
                        ...
                        <div>
                            <h3 className="text-xl font-bold">Barbara McGillivray (Primary Supervisor)</h3>
                        ...
                        <div>
                            <h3 className="text-xl font-bold">Andrea Ballatore (Second Supervisor)</h3>
                        ...
                        <div>
                            <h3 className="text-xl font-bold">Stephen Colvin (Third Supervisor)</h3>
                        ...
                        <div>
                            <h3 className="text-xl font-bold">Zsolt Balla (Technical Lead)</h3>
                        ...
                        <div>
                            <h3 className="text-xl font-bold">Sanjana Prabhakar (Research Assistant / Web Developer)</h3>
