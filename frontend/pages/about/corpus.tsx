...
const Corpus = () => {
    return (
        <div className="container mx-auto py-8 max-w-4xl">
            ...
            <h1 className="text-3xl font-bold mt-6 mb-2">Corpus</h1>
            ...
            <div className="prose max-w-none space-y-8">
                ...
                <section>
                    <h2 className="text-2xl font-semibold mb-4">Corpus Composition</h2>
                ...
                <section>
                    <h2 className="text-2xl font-semibold mb-4">Ancient Greek Corpus</h2>
                ...
                <section>
                    <h2 className="text-2xl font-semibold mb-4">Latin Corpus</h2>
                    <div className="overflow-x-auto">
                        <table className="min-w-full border-collapse my-6">
                            <thead>
                                <tr className="bg-muted/50">
                ...
                <section>
                    <h2 className="text-2xl font-semibold mb-4">Sources and Annotations</h2>
                ...
                <section>
                    <h2 className="text-2xl font-semibold mb-4">Corpus Balance</h2>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8 my-6">
                        <div>
                            <h3 className="text-xl font-bold mb-3">Greek: Distribution by Period</h3>
                            <ul className="list-disc pl-6 space-y-2">
                        ...
                        <div>
                            <h3 className="text-xl font-bold mb-3">Latin: Distribution by Period</h3>
                            <ul className="list-disc pl-6 space-y-2">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8 my-6">
                        <div>
                            <h3 className="text-xl font-bold mb-3">Greek: Distribution by Genre</h3>
                            <ul className="list-disc pl-6 space-y-2">
                        ...
                        <div>
                            <h3 className="text-xl font-bold mb-3">Latin: Distribution by Genre</h3>
                            <ul className="list-disc pl-6 space-y-2">
