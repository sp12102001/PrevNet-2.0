        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 py-8 space-y-8">
            ...
            <div className="bg-white dark:bg-card rounded-xl shadow-sm p-8 space-y-6">
                <p className="text-lg text-muted-foreground">
                    This guide will help you understand how to use PrevNet effectively.
                    Detailed instructions and examples will be provided to help you explore preverbs, their meanings, and their usage in Latin and Ancient Greek texts.
                </p>
